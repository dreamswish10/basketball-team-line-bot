...
from linebot.models import (
    ...
    PostbackAction, URIAction, PostbackEvent, FlexContainer
)
...
class LineMessageHandler:
    ...
    def _send_flex_message(self, reply_token, alt_text, flex_content):
        ...
        try:
            ...
            message = FlexSendMessage(alt_text=alt_text, contents=FlexContainer.from_json({
  "type": "carousel",
  "contents": [
    {
      "type": "bubble",
    ...
    def _create_custom_team_result_flex(self, teams, mapping_info):
        ...
        # 創建 Carousel
        carousel = CarouselContainer.from_json({
  "type": "carousel",
  "contents": [
    {
      "type": "bubble",
